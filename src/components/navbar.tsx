      ...
      <div className="grid items-center mx-auto h-[80px] max-w-[1596px] shadow-primary">
        <ul className="grid grid-cols-3">
          ...
          <li className="relative flex justify-end items-center">
            <Link to="/signin" className={`${user.url ? "hidden" : "visible"}`}>
            ...
            <div
              className={`${
                toggle && user.url ? "visible" : "hidden"
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <div className="text-sm font-bold mb-[7px]">{user.name}</div>
              </div>
